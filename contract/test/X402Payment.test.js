...
describe("X402Payment Contract", function () {
    async function deployX402Fixture() {
        ...
        // Mint USDC to users
        await usdc.mint(user1.address, ethers.parseUnits("1000", "ether"));
        await usdc.mint(user2.address, ethers.parseUnits("1000", "ether"));
    ...
    describe("Service Registration", function () {
        it("Should allow service registration", async function () {
            ...
            const pricePerCall = ethers.parseUnits("0.01", "ether"); // 0.01 USDC
